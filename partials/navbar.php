      ...
      <div class="container offset-3">
        ...
        <div class="navbar-header">
          <button data-target=".navbar-collapse" data-toggle="collapse" class="navbar-toggle" type="button">
            ...
            <span class="icon-bar"></span>
            <span class="igecon-bar"></span>
          </button>
          <a href="/updatedversion-master/index.php" class="navbar-brand"><img src="/updatedversion-master/nimun.png" alt="NIMUN '17" class="logo"/></a>
        </div>

        <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <a href="/updatedversion-master/index.php">HOME</a>
            </li>
              ...
              <li>
                <div class="row" style="width:250px;">
                  <ul class="droplist col-md-12">
                    <li><a href="/updatedversion-master/about/muns/index.php">What is NIMUN?</a></li>
                    <li><a href="/updatedversion-master/about/tourism/index.php">Pakistan: Culture &amp Tourism</a></li>
                    <li><a href="/updatedversion-master/about/islamabad/index.php">Islamabad - The Capital</a></li>
            ...
            <li class="dropdown">
              <a data-toggle="dropdown" class="dropdown-toggle" href="#">NIMUN'17</a>
              <ul class="dropdown-menu posleft-0">
                <li>
                  <div class="row" style="width:200px;">
                    <ul class="droplist col-md-12">
                      <li><a href="/updatedversion-master/nimun/nimun14/index.php">Introduction</a></li>
                      <li><a href="/updatedversion-master/nimun17/conferenceTheme/index.php">Conference Theme</a></li>
                      <li><a href="/updatedversion-master/nimun17/historyOfNIMUN/index.php">History of NIMUN</a></li>
                    </ul>
                  </div>
                </li>
              </ul>
            ...
            <li class="dropdown">
              <a data-toggle="dropdown" class="dropdown-toggle" href="#">OUR TEAM</a>
              <ul class="dropdown-menu posleft-0">
                <li>
                  <div class="row" style="width:200px;">
                    <ul class="droplist col-md-12">
                      <li><a href="/updatedversion-master/nimun/nimun14/index.php">Executive Council</a></li>
                      <li><a href="/updatedversion-master/nimun/nimun15/index.php">Directorate</a></li>
                    </ul>
                  </div>
                </li>
              </ul>
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">CONFERENCE</a>
            <ul class="dropdown-menu posleft-0">
              <li>
                <div class="row" style="width:670px;">
                  ...
                  <ul class="droplist col-md-3">
                    ...
                    <li><a href="/updatedversion-master/conference/committees/general-assembly/index.php">Security Council</a></li>
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">REGISTRATION</a>
            <ul class="dropdown-menu posleft-0">
              <li>
                <div class="row" style="width:500px;">
                  <ul class="droplist col-md-6">
                    ...
                    <li class="dropdown-header">Have an account?</li>
                    <li><a href="login">Login</a></li>
                  </ul>
                  <ul class="droplist col-md-6">
                    <li class="dropdown-header">More Details</li>
                    <li><a href="list.html">How to register</a></li>
                    <li><a href="list2.html">Registration Timeline</a></li>
                  </ul>
                </div>
              </li>
            </ul>
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">INTERNATIONAL</a>
            <ul class="dropdown-menu posleft-0">
              <li>
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">MEDIA</a>
            <ul class="dropdown-menu posleft-0">
              <li>
                <div class="row" style="width:200px;">
                  <ul class="droplist col-md-12">
                    <li><a href="/updatedversion-master/international/visa/index.php">Publications &amp Press</a></li>
                    <li><a href="/updatedversion-master/international/registeration/index.php">Gallery</a></li>
                  </ul>
                </div>
              </li>
            </ul>
